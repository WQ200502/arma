...
Config.Zones = {
    BikeRental = {
        ...
        Items = { -- Item, label, and price used for the menu
            {item = 'BMX', label = '小型自行车', price = 300},
            {item = 'CRUISER', label = '巡洋舰自行车', price = 300},
            {item = 'FIXTER', label = '回旋曲自行车', price = 300},
            {item = 'SCORCHER', label = '山地车', price = 300},
            {item = 'TRIBIKE', label = '铁人三项赛1', price = 300},
            {item = 'TRIBIKE2', label = '铁人三项赛2', price = 300},
            {item = 'TRIBIKE3', label = '铁人三项赛3', price = 300},
        },
        Pos = { -- Zone positions
    ...
    Basejumping = {
        ...
        Items = { -- Item, label, and price used for the menu
            {item = 'GADGET_PARACHUTE', label = '降落伞', price = 300},
        },
        Pos = { -- Zone positions
