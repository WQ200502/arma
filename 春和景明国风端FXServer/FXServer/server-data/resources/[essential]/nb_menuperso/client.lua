...
function OpenPersonnelMenu()
	...
	ESX.TriggerServerCallback('NB:getUsergroup', function(group)
		...
		table.insert(elements, {label = '个人信息',		value = 'menuperso_moi'})
		table.insert(elements, {label = '行动',					value = 'menuperso_actions'})
		if (IsInVehicle()) then
			local vehicle = GetVehiclePedIsIn( GetPlayerPed(-1), false )
			if ( GetPedInVehicleSeat( vehicle, -1 ) == GetPlayerPed(-1) ) then
				table.insert(elements, {label = '车辆',					value = 'menuperso_vehicule'})
			end
		end
		table.insert(elements, {label = '快速全球定位系统',			value = 'menuperso_gpsrapide'})
		if PlayerData.job.grade_name == '老板' then
			table.insert(elements, {label = '企业管理',			value = 'menuperso_grade'})
		end
				
		if playergroup == 'mod' or playergroup == 'admin' or playergroup == 'superadmin' or playergroup == 'owner' then
			table.insert(elements, {label = '管理员菜单',				value = 'menuperso_modo'})
		end
		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if playergroup == 'mod' then
					table.insert(elements, {label = '玩家网路',    							value = 'menuperso_modo_tp_toplayer'})
					table.insert(elements, {label = '在我身上的玩家',             			value = 'menuperso_modo_tp_playertome'})
					...
					table.insert(elements, {label = '显示/隐藏坐标',		value = 'menuperso_modo_showcoord'})
					table.insert(elements, {label = '显示/隐藏玩家名称',	value = 'menuperso_modo_showname'})
				...
				if playergroup == 'admin' then
					...
					table.insert(elements, {label = '在我身上的玩家',             			value = 'menuperso_modo_tp_playertome'})
					--table.insert(elements, {label = 'TP sur coordonées [WIP]',						value = 'menuperso_modo_tp_pos'})
					table.insert(elements, {label = '穿墙模式',										value = 'menuperso_modo_no_clip'})
					table.insert(elements, {label = '无敌模式',									value = 'menuperso_modo_godmode'})
					table.insert(elements, {label = '幽灵模式',								value = 'menuperso_modo_mode_fantome'})
					table.insert(elements, {label = '修理车辆',							value = 'menuperso_modo_vehicle_repair'})
					table.insert(elements, {label = '使车辆露面',							value = 'menuperso_modo_vehicle_spawn'})
					table.insert(elements, {label = '翻车',								value = 'menuperso_modo_vehicle_flip'})
					table.insert(elements, {label = '给钱',						value = 'menuperso_modo_give_money'})
					table.insert(elements, {label = '给予货币（银行）',						value = 'menuperso_modo_give_moneybank'})
					table.insert(elements, {label = '给予黑钱',						value = 'menuperso_modo_give_moneydirty'})
					table.insert(elements, {label = '显示/隐藏坐标',		value = 'menuperso_modo_showcoord'})
					table.insert(elements, {label = '显示/隐藏玩家名称',	value = 'menuperso_modo_showname'})
					table.insert(elements, {label = '传送到标记位置',							value = 'menuperso_modo_tp_marcker'})
					table.insert(elements, {label = '护理病人',					value = 'menuperso_modo_heal_player'})
					--table.insert(elements, {label = 'Mode spectateur [WIP]',						value = 'menuperso_modo_spec_player'})
					table.insert(elements, {label = '改变外表',									value = 'menuperso_modo_changer_skin'})
					table.insert(elements, {label = '保持外观',									value = 'menuperso_modo_save_skin'})
				end
			
				if playergroup == 'superadmin' or playergroup == 'owner' then
					table.insert(elements, {label = '玩家网路',    							value = 'menuperso_modo_tp_toplayer'})
					table.insert(elements, {label = '在我身上的玩家',             			value = 'menuperso_modo_tp_playertome'})
					table.insert(elements, {label = '传送到坐标上[WIP]',						value = 'menuperso_modo_tp_pos'})
					table.insert(elements, {label = '穿墙模式',										value = 'menuperso_modo_no_clip'})
					table.insert(elements, {label = '无敌模式',									value = 'menuperso_modo_godmode'})
					table.insert(elements, {label = '幽灵模式',								value = 'menuperso_modo_mode_fantome'})
					table.insert(elements, {label = '修理车辆',							value = 'menuperso_modo_vehicle_repair'})
					...
					table.insert(elements, {label = '传送到标记位置',							value = 'menuperso_modo_tp_marcker'})
					table.insert(elements, {label = '护理病人',					value = 'menuperso_modo_heal_player'})
					table.insert(elements, {label = '观众模式',						value = 'menuperso_modo_spec_player'})
					table.insert(elements, {label = '改变外表',									value = 'menuperso_modo_changer_skin'})
					table.insert(elements, {label = '保持外观',									value = 'menuperso_modo_save_skin'})
				end
				...
				if data.current.value == 'menuperso_moi' then
					...
					table.insert(elements, {label = '个人信息',             					value = 'menuperso_moi_inventaire'})
					table.insert(elements, {label = '我的账单',							value = 'menuperso_moi_factures'})
				...
				if data.current.value == 'menuperso_actions' then
					...
					ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menuperso_actions',
						{
							...
							align    = 'top-left',
							elements = {
								{label = '取消动作',  value = 'menuperso_actions__annuler'},
								--{label = 'Faire ses besoins [WIP]',     value = 'menuperso_actions_pipi'},
								{label = '问候动作',  value = 'menuperso_actions_Salute'},
								{label = '情绪动作',  value = 'menuperso_actions_Humor'},
								{label = '动画动作',  value = 'menuperso_actions_Travail'},
								{label = '节日动作',  value = 'menuperso_actions_Festives'},
								{label = '其他动作',  value = 'menuperso_actions_Others'},
							},
						},
						function(data2, menu2)
							...
							if data2.current.value == 'menuperso_actions_Salute' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Salute',
									{
										...
										align    = 'top-left',
										elements = {
											{label = '打招呼',  value = 'menuperso_actions_Salute_saluer'},
											{label = '握手',     value = 'menuperso_actions_Salute_serrerlamain'},
											{label = 'Yeah',     value = 'menuperso_actions_Salute_tapeen5'},
											{label = '敬礼',  value = 'menuperso_actions_Salute_salutmilitaire'},
										},
									},
							...
							if data2.current.value == 'menuperso_actions_Humor' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Humor',
									{
										...
										align    = 'top-left',
										elements = {
											{label = '祝贺',  value = 'menuperso_actions_Humor_feliciter'},
											{label = '太好了',     value = 'menuperso_actions_Humor_super'},
											{label = '冷静点',     value = 'menuperso_actions_Humor_calmetoi'},
											{label = '害怕',  value = 'menuperso_actions_Humor_avoirpeur'},
											{label = '不可能！',  value = 'menuperso_actions_Humor_cestpaspossible'},
											{label = '拥抱',  value = 'menuperso_actions_Humor_enlacer'},
											{label = '荣誉手指',  value = 'menuperso_actions_Humor_doightdhonneur'},
											{label = '混蛋',  value = 'menuperso_actions_Humor_branleur'},
											{label = '头部子弹',  value = 'menuperso_actions_Humor_balledanslatete'},
										},
									},
									function(data3, menu3)
							...
							if data2.current.value == 'menuperso_actions_Travail' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Travail',
									{
										...
										align    = 'top-left',
										elements = {
											{label = '渔民',  value = 'menuperso_actions_Travail_pecheur'},
											{label = '农民',     value = 'menuperso_actions_Travail_agriculteur'},
											{label = '拖车',     value = 'menuperso_actions_Travail_depanneur'},
											{label = '写笔记',  value = 'menuperso_actions_Travail_prendredesnotes'},
											{label = '检查',  value = 'menuperso_actions_Travail_inspecter'},
										},
									},
									function(data3, menu3)
							...
							if data2.current.value == 'menuperso_actions_Festives' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Festives',
									{
										...
										align    = 'top-left',
										elements = {
											{label = '跳舞',  value = 'menuperso_actions_Festives_danser'},
											{label = '演奏音乐',     value = 'menuperso_actions_Festives_jouerdelamusique'},
											{label = '喝啤酒',     value = 'menuperso_actions_Festives_boireunebiere'},
											{label = '空气吉他',  value = 'menuperso_actions_Festives_airguitar'},
										},
									},
									function(data3, menu3)
							...
							if data2.current.value == 'menuperso_actions_Others' then
								ESX.UI.Menu.Open(
									'default', GetCurrentResourceName(), 'menuperso_actions_Others',
									{
										...
										align    = 'top-left',
										elements = {
											{label = '抽烟',     value = 'menuperso_actions_Others_fumeruneclope'},
											{label = '做水泵',     value = 'menuperso_actions_Others_fairedespompes'},
											{label = '看双胞胎',     value = 'menuperso_actions_Others_regarderauxjumelles'},
											{label = '瑜伽',     value = 'menuperso_actions_Others_faireduyoga'},
											{label = '雕像',     value = 'menuperso_actions_Others_fairelastatut'},
											{label = '慢跑',     value = 'menuperso_actions_Others_fairedujogging'},
											{label = '显示肌肉',     value = 'menuperso_actions_Others_fairedesetirements'},
											{label = '摆姿势',     value = 'menuperso_actions_Others_racoller'},
											{label = '摆姿势2',     value = 'menuperso_actions_Others_racoller2'},
											{label = '坐下',     value = 'menuperso_actions_Others_sasseoir'},
											{label = '坐在地上',     value = 'menuperso_actions_Others_sasseoirparterre'},
											{label = '等待',     value = 'menuperso_actions_Others_attendre'},
											{label = '清理',     value = 'menuperso_actions_Others_nettoyerquelquechose'},
											{label = '举起手',     value = 'menuperso_actions_Others_leverlesmains'},
											{label = '搜索位置',     value = 'menuperso_actions_Others_positiondefouille'},
											{label = '抓蛋蛋',     value = 'menuperso_actions_Others_segratterlesc'},
											{label = '自我介绍',     value = 'menuperso_actions_Others_prendreunselfie'},
										},
									},
									function(data3, menu3)
				...
				if data.current.value == 'menuperso_gpsrapide' then
					ESX.UI.Menu.Open(
						'default', GetCurrentResourceName(), 'menuperso_gpsrapide',
						{
							...
							align    = 'top-left',
							elements = {
								{label = '就业中心',     value = 'menuperso_gpsrapide_poleemploi'},
								{label = '主要喜剧演员',              value = 'menuperso_gpsrapide_comico'},
								{label = '主要医院', value = 'menuperso_gpsrapide_hopital'},
								{label = '特许公司',  value = 'menuperso_gpsrapide_concessionnaire'}
							},
						},
						function(data2, menu2)
