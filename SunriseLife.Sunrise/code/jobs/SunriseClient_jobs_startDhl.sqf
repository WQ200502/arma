/*
	...
	Filename: 	SunriseClient_jobs_startDhl.sqf
...
private _task = [["JOB_DHL"],_spawnPointPos,["Покиньте биржу труда и отправляйтесь в офис DHL за спец. одеждой и техникой! У вас 15 минут!","Отправляйтесь в офис DHL","meet"]] call SunriseClient_system_createTask;

[{player distance (_this#0) < 10}, {
	life_dhl_readyToWork = true;
