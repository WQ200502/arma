/*
	...
	Filename: 	SunriseClient_factory_vehicleProcessMenu.sqf
	Project: 	Sunrise Life
	Author:		Sunrise Team
	Steam:		Sunrise Team

	this addAction["Начать переработку",SunriseClient_factory_vehicleProcessMenu,"ironore",3,true,true,"","",15];
*/
...
_button ctrlSetText "Начать переработку";
_button buttonSetAction format ["['%1',call compile lbData[5802,lbCurSel (5802)],%2] spawn SunriseClient_factory_vehicleProcess",_resource,_object];
lbclear _control;
{	
