/*
	...
	Filename:   SunriseClient_system_createElectra.sqf
...
_trg setTriggerStatements ["this and !(thisTrigger getVariable ['anomaly_cooldown',false])", "[thisTrigger,thisList] spawn SunriseClient_hazard_activateElectra", ""];
