/*
	...
	Filename: 	SunriseClient_pad_openStatus.sqf
...
if (isNull (findDisplay 7200)) then {
	createDialog "SunriseDialogPadStatus";
...
private _licenses = CONTROL(7200,7208);
private _near_money = CONTROL(7200,7205);
private _notifications_list = CONTROL(7200,7211);
private _vehicles_list = CONTROL(7200,7213);
private _near_vehicles = CONTROL(7200,7214);
