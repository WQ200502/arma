/*
	...
	Filename: 	SunriseClient_jail_truckUnloadMenu.sqf
...
_button ctrlSetText "Начать рагрузку";
_button buttonSetAction "[call compile lbData[5802,lbCurSel (5802)]] spawn SunriseClient_jail_unloadTruck";
lbclear _control;
{	
