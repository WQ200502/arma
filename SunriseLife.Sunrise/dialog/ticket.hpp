class SunriseDialogTicketGive
{
	idd = 2650;
	name = "SunriseDialogTicketGive";
	movingEnabled = 0;
	enableSimulation = 1;
	...
	class controls 
	{
		...
		class payTicket: RscExtremoGui_ButtonDark {
			...
			onButtonClick = "[] call SunriseClient_system_ticketGive";
...
class SunriseDialogTicketPay
{
	idd = 2600;
	name = "SunriseDialogTicketPay";
	movingEnabled = 0;
	enableSimulation = 1;
	...
	class controls 
	{
		class title: Life_V3_Title {
			idc = -1;
			text = "Оплата штрафа"; //--- ToDo: Localize;
			colorBackground[] = {TLD_COLOR_1,0.9};
			x = 0.349063 * safezoneW + safezoneX;
		...
		class payTicket: RscExtremoGui_ButtonDark {
			...
			onButtonClick = "[] call SunriseClient_system_ticketPay;";
