class SunriseDialogCredit {
	idd = 3400;
	name= "SunriseDialogCredit";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class GetCreditButton : RscButtonMenu {
			idc = 3404;
			text = "Получить";
			onButtonClick = "[1] call SunriseClient_credit_sendRequest;";
		...
		class RepayCreditButton : RscButtonMenu {
			idc = 3405;
			text = "Погасить";
			onButtonClick = "[0] call SunriseClient_credit_sendRequest;";
