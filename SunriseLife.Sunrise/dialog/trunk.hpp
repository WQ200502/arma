class SunriseDialogTrunk
{
	idd = 3500;
	name = "SunriseDialogTrunk";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class Controls
	{
		...
		class TakeItem : RscButtonUC
		{
			idc = -1;
			text = "$STR_Trunk_Take";			
			onButtonClick = "[] call SunriseClient_system_vehTakeItem;";
		...
		class TakeAllItems : RscButtonUC
		{
			idc = -1;
			text = "Взять все";			
			onButtonClick = "[true] call SunriseClient_system_vehTakeItem;";
		...
		class StoreItem : RscButtonUC
		{
			...
			onButtonClick = "[] call SunriseClient_system_vehStoreItem;";
		...
		class StoreAllItems : RscButtonUC
		{
			idc = -1;
			text = "Положить все";			
			onButtonClick = "[true] call SunriseClient_system_vehStoreItem;";
