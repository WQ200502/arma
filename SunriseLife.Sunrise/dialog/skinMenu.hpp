class SunriseDialogSkinSetup {
	idd = 6000;
	name= "SunriseDialogSkinSetup";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class editbox_demo: RscExtremoGui_Edit
		{
			idc = 6002;
		...
		{
			idc = 6003;
			text = "Тестовая надпись для примера"; //--- ToDo: Localize;
			x = 0.375313 * safezoneW + safezoneX;
		...
		class skin_select: Life_V3_RscCombo
		{
			...
			onLBSelChanged = "_this call SunriseClient_hud_skinUpdate";
		};
		...
		class ButtonClose : RscExtremoGui_ButtonDark
		{
			idc = -1;
			text = "Обновить";			
