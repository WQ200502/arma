class SunriseDialogGangContainer
{
	idd = 4800;
	name = "SunriseDialogGangContainer";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class Controls
	{
		...
		class TakeItem : RscButtonUC
		{
			idc = 4809;
			text = "Взять";			
			onButtonClick = "[] spawn SunriseClient_gangs_BoxTakeItem;";
		...
		class StoreItem : RscButtonUC
		{
			idc = 4808;
			text = "Положить";			
			onButtonClick = "[] spawn SunriseClient_gangs_BoxStoreItem;";
		...
		{
			idc = 4807;
			onLBSelChanged = "_this call SunriseClient_gangs_BoxMenuFilter";
			x = 0.303569 * safezoneW + safezoneX;
