class SunriseDialogVehTransfer
{
	idd = 5100;
	name="SunriseDialogVehTransfer";
	movingEnabled = 0;
	enableSimulation = 1;
	...
	class controls
	{
		...
		class VehicleList : Life_V3_RscListBox
		{
			...
			onLBSelChanged = "_this call SunriseClient_system_vehTransferLBChange";
		...
		class GetCar : RscExtremoGui_ButtonDark
		{
			idc = 5104;
			text = "Доставить";
			onButtonClick = "[] call SunriseClient_system_vehTransferGet";
