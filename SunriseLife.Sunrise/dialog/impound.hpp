class SunriseDialogImpound
{
	idd = 2800;
	name="SunriseDialogImpound";
	movingEnabled = 0;
	enableSimulation = 1;
	...
	class controls
	{
		...
		class VehicleList : Life_V3_RscListBox
		{
			...
			onLBSelChanged = "_this call SunriseClient_garage_LBChange";
		...
		class RetrieveCar : Life_V3_ButtonMenu
		{
			...
			onButtonClick = "[] call SunriseClient_garage_getVehicle";
		...
		class SellCar : Life_V3_ButtonMenu 
		{
			...
			onButtonClick = "[] spawn SunriseClient_garage_SellVehicle";
		...
		class InsurPayCar : Life_V3_ButtonMenu
		{
			...
			onButtonClick = "[] call SunriseClient_system_insurancePay";
