class SRRscPicture : RscPicture {
	colorText[] = {"(profilenamespace getvariable ['GUI_V3_BTBG_R',0])", "(profilenamespace getvariable ['GUI_V3_BTBG_G',0])", "(profilenamespace getvariable ['GUI_V3_BTBG_B',0])", 1};
	fade = 1;
};
class SRRscPictureButtonMenu : RscPictureButtonMenu {
	onMouseExit = "['onExit',_this] spawn SunriseClient_pad_interact";
	onMouseEnter = "['onEnter',_this] spawn SunriseClient_pad_interact";
	periodFocus = 0;
	periodOver = 0;
	period = 0;
	fade = 1;
...
class SunriseDialogPadMain {
	idd = 2000;
	name= "SunriseDialogPadMain";
	movingEnable = 1;
	enableSimulation = 1;
	...
	class controls {
		...
		class DropKey : RscExtremoGui_ButtonRed {
			...
			onButtonClick = "[] call SunriseClient_system_keyDropStat";
		...
		class GiveKey : RscExtremoGui_ButtonGreen {
			...
			onButtonClick = "[] call SunriseClient_system_keyGiveStat";
