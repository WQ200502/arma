class SunriseDialogGovAtm {
	idd = 3900;
	name= "SunriseDialogGovAtm";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class WithdrawButton : RscButtonMenu 
		{
			...
			onButtonClick = "[""take""] call SunriseClient_system_govBank";
		...
		class DepositButton : RscButtonMenu 
		{
			...
			text = "Внести";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[""add""] call SunriseClient_system_govBank";
