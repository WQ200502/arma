class SunriseDialogAddWarpoint {
	idd = 4400;
	name= "SunriseDialogAddWarpoint";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class GetCoordButton : RscButtonUC {
			idc = -1;			
			text = "Карта";
			onButtonClick = "closedialog 0; [] spawn SunriseClient_martiallaw_getWarPointCoord";
		...
		class AddButton : RscButtonUC {
			idc = -1;			
			text = "Добавить";
			onButtonClick = "[] spawn SunriseClient_martiallaw_addWarPointToServer";
