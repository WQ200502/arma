class SunriseDialogCraftShop {
	idd = 1401;
	name= "SunriseDialogCraftShop";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		{
			idc = 668;
			onLBSelChanged = "_this call SunriseClient_crafting_ShopFilter";			
			x = 0.314938 * safezoneW + safezoneX;
		...
		class ButtonCraftBuy : RscButtonMenu {
			idc = 674;
			text = "Купить";
			onButtonClick = "[] spawn SunriseClient_crafting_Buy";
