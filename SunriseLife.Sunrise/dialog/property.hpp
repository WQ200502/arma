class SunriseDialogPropertyMenu {
	idd = 4370;
	name= "SunriseDialogPropertyMenu";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class Houses: Life_V3_RscCombo {
			idc = 2702;
			onLBSelChanged = "[] spawn SunriseClient_system_propertyMenuSelect;";
		...
		class HouseInfo: Life_V3_RscStructuredText {
			idc = 2703;
		...
		class AddSlot: RscExtremoGui_ButtonDark {
			idc = 2705;
			onButtonClick = "[life_curHouseSel] spawn SunriseClient_system_houseModAddSlot";

			text = "Добавить слот"; //--- ToDo: Localize;
			x = 0.0375;
			y = 0.24;
			w = 0.2625;
			h = 0.05;
		...
		class Lights: RscExtremoGui_ButtonDark {
			idc = 2704;
			onButtonClick = "[life_curHouseSel] call SunriseClient_system_lightHouseAction";

			text = "Освещение"; //--- ToDo: Localize;
			x = 0.0375;
			y = 0.32;
			w = 0.2625;
			h = 0.05;
		...
		class Security: RscExtremoGui_ButtonDark {
			idc = 2706;
			onButtonClick = "[life_curHouseSel] spawn SunriseClient_system_houseBuySecurity;";

			text = "Установить охрану"; //--- ToDo: Localize;
			x = 0.0375;
			y = 0.4;
			w = 0.2625;
			h = 0.05;
		...
		class PayRent: RscExtremoGui_ButtonDark {
			idc = 2708;
			onButtonClick = "[life_curHouseSel] spawn SunriseClient_system_housePayRent;";

			text = "Оплатить на 1 мес."; //--- ToDo: Localize;
			x = 0.0375;
			y = 0.48;
			w = 0.2625;
			h = 0.05;
		...
		class SellHouse: RscExtremoGui_ButtonDark {
			idc = 2709;
			onButtonClick = "[life_curHouseSel] spawn SunriseClient_system_sellHouse;";
		...
		class FAQ: Life_V3_RscStructuredText {
			idc = 2710;
