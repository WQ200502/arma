class SunriseDialogPouch
{
	idd = 4100;
	name = "SunriseDialogPouch";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controlsBackground
	{
		...
		class PouchWeight : RscTitleText
		{
			idc = 4104;
	...
	class Controls
	{
		...
		class TakeItem : RscButtonUC
		{
			idc = 4109;
			text = "Взять";			
			onButtonClick = "[] spawn SunriseClient_pouch_pouchTakeItem;";
		...
		class StoreItem : RscButtonUC
		{
			idc = 4108;
			text = "Положить";			
			onButtonClick = "[] spawn SunriseClient_pouch_pouchStoreItem;";
		...
		{
			idc = 4107;
			onLBSelChanged = "_this call SunriseClient_pouch_pouchMenuFilter";
			x = 0.303569 * safezoneW + safezoneX;
