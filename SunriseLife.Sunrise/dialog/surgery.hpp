class SunriseDialogSurgery {
	idd = 5400;
	name= "SunriseDialogSurgery";
	movingEnable = 1;
	enableSimulation = 1;
	...
	class controls 
	{
		...
		class FacesList : RscListBox 
		{
			idc = 5402;
			text = "";
			onLBSelChanged = "[_this] call SunriseClient_surgery_Change";
		...
		class BuyButtonKey : RscButtonUC 
		{
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call SunriseClient_surgery_SetFace";
