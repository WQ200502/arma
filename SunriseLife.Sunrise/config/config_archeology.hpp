...
class LifeCfgArcheology {
	...
	initItem = "srl_metalDetector"; //предмет, который запускает всю херню
	workItem = "sunrise_Tool_Shovel"; //предмет, которым надо ДОБЫВАТЬ (лопата в нашем случае)
